...
func (x *CreateUserResponse) GetTelegramId() int64 {
	if x != nil {
		return x.TelegramId
	}
	return 0
...
func (x *GetUserResponse) GetTelegramId() int64 {
	if x != nil {
		return x.TelegramId
	}
	return 0
...
type ListUsersResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Items         []*GetUserResponse     `protobuf:"bytes,1,rep,name=items,proto3" json:"items,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListUsersResponse) GetItems() []*GetUserResponse {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *UpdateUserResponse) GetSurname() string {
	if x != nil && x.Surname != nil {
		return *x.Surname
	}
	return ""
...
func (x *UpdateUserResponse) GetTelegramId() int64 {
	if x != nil {
		return x.TelegramId
	}
	return 0
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\auser.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"s\n" +
	"\x11CreateUserRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12\x1d\n" +
	"\asurname\x18\x02 \x01(\tH\x00R\asurname\x88\x01\x01\x12\x1f\n" +
	...
	"\asurname\x18\x03 \x01(\tH\x00R\asurname\x88\x01\x01\x12\x1f\n" +
	...
	"\x05items\x18\x01 \x03(\v2\x18.user.v1.GetUserResponseR\x05items\"\x83\x01\n" +
	...
	"\n" +
	"DeleteUser\x12\x1a.user.v1.DeleteUserRequest\x1a\x1b.user.v1.DeleteUserResponseB\x1bZ\x19go-template/gen/go/userpbb\x06proto3"
...
var file_user_proto_depIdxs = []int32{
	...
	3,  // 1: user.v1.ListUsersResponse.items:type_name -> user.v1.GetUserResponse
	...
	4,  // 4: user.v1.UserService.ListUsers:input_type -> user.v1.ListUsersRequest
